...
const pages = [
  ...
  'auth-guard.js?v=21', 'smart-alert.js?v=3', 'runtime-health.js?v=1', 'module-operations.js?v=1'
];
...
try {
  ...
  if (!home.includes('auth-guard.js?v=21')) failures.push('home.html: stale auth guard cache version');
