﻿(function () {
  ...
  function loadHomeCommandOverview() {
    ...
    const script=document.createElement('script');script.src=new window.URL('home-command-overview.js?v=4',location.href).href;script.defer=true;document.head.appendChild(script);
  }
