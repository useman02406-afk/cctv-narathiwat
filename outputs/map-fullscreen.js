...
(() => {
  ...
  function toggleFullScreen(element, button) {
    ...
    // Keep the Leaflet container in its original parent. Re-parenting it causes
    // stale tile dimensions and delayed popups in iframe/mobile layouts.
    ...
    notifyParent(active);
    refreshMap(element, [0, 50, 180, 420]);
  }
